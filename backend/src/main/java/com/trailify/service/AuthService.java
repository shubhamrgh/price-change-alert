...
public class AuthService {
    ...
    public AuthService(UserAccountRepository users,
                       ...
                       @Value("${trailify.auth.session-ttl:30d}") Duration sessionTtl,
                       @Value("${trailify.auth.magic-link-ttl:15m}") Duration magicLinkTtl,
                       @Value("${trailify.auth.password-reset-ttl:30m}") Duration resetTtl,
                       @Value("${trailify.base-url:http://localhost:8080}") String baseUrl,
                       @Value("${trailify.auth.google.client-id:}") String googleClientId) {
        this.users = users;
    ...
    public void requestMagicLink(String email) {
        ...
        String raw = authTokens.create(normalizedEmail, com.trailify.model.AuthToken.Type.MAGIC_LOGIN,
                magicLinkTtl);
    ...
    public UserAccount consumeMagicLink(String rawToken, String legacyOwnerId,
        ...
        String email = authTokens.consume(rawToken, com.trailify.model.AuthToken.Type.MAGIC_LOGIN)
    ...
    public void requestPasswordReset(String email) {
        ...
        String raw = authTokens.create(normalizedEmail, com.trailify.model.AuthToken.Type.PASSWORD_RESET,
                resetTtl);
    ...
    public void resetPassword(String rawToken, String newPassword) {
        ...
        if (authTokens == null) throw new ResponseStatusException(HttpStatus.SERVICE_UNAVAILABLE,
                "Password reset is not configured");
        String email = authTokens.consume(rawToken, com.trailify.model.AuthToken.Type.PASSWORD_RESET)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.BAD_REQUEST,
