...
import com.trailify.model.PasskeyChallenge;
import com.trailify.model.PasskeyCredential;
import com.trailify.model.UserAccount;
import com.trailify.repository.PasskeyChallengeRepository;
import com.trailify.repository.PasskeyCredentialRepository;
...
public class PasskeyService {
    ...
    public PasskeyService(PasskeyCredentialRepository credentials,
                          ...
                          @Value("${trailify.auth.passkeys.challenge-ttl:5m}") Duration challengeTtl,
                          @Value("${trailify.auth.passkeys.rp-id:localhost}") String rpId,
                          @Value("${trailify.auth.passkeys.rp-name:Trailify}") String rpName,
                          @Value("${trailify.auth.passkeys.origins:http://localhost:8080,http://localhost:5173}")
                          String origins) {
