...
import com.trailify.source.PriceService;
...
public class AlertService {
    ...
    public AlertService(WatchItemRepository watchItemRepository,
                        ...
                        @Value("${trailify.poll.max-quote-age:2m}") Duration maxQuoteAge) {
    ...
    @Scheduled(fixedDelayString = "${trailify.poll.interval-ms:30000}")
    public void poll() {
